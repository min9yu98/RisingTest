...
public class InquiryService {
    ...
    @Transactional
    public void createInquiry(CreateInquiryReq createInquiryReq, int userIdx, int orderIdx) throws BaseException {
        try {
                inquiryDao.createInquiry(createInquiryReq, userIdx, orderIdx);
